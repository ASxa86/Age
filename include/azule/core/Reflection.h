	...
	namespace core
	{
		...
		public:
			...
			bool setValue(const impl::AnyRef& x, const std::string& v) override
			{
				...
				if(obj != nullptr)
				{
					obj->*property = azule::utilities::StringTo<A>(v);
					return true;
				}
			...
			std::string getValue(const impl::AnyRef& x) const override
			{
				...
				if(obj != nullptr)
				{
					s = azule::utilities::ToString(obj->*property);
				}
		...
		public:
			...
			bool setValue(const impl::AnyRef& x, const std::string& v) override
			{
				...
				if(obj != nullptr)
				{
					(obj->*setter)(azule::utilities::StringTo<Arg>(v));
					return true;
				}
			...
			std::string getValue(const impl::AnyRef& x) const override
			{
				...
				if(obj != nullptr)
				{
					s = azule::utilities::ToString((obj->*getter)());
				}
		...
		private:
			...
			std::vector<azule::utilities::SharedLibrary> libraries;
