...
namespace azule
{
	namespace core
	{
		...
		protected:
			[[nodiscard]] azule::utilities::ScopedConnection addOnAddChild(std::function<void(Object*)> x);
			[[nodiscard]] azule::utilities::ScopedConnection addOnRemoveChild(std::function<void(Object*)> x);
			void track(azule::utilities::ScopedConnection x);
		...
		private:
			...
			std::vector<azule::utilities::ScopedConnection> connection;
			azule::utilities::Signal<Object*> onAddChild;
			azule::utilities::Signal<Object*> onRemoveChild;
			std::string id;
