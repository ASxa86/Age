...
STATIC_INVOKE
{
	ObjectFactoryRegister(azule::Object);
	ObjectFactoryRegister(azule::Engine);
	ObjectFactoryRegister(azule::EntityDatabase);
	ObjectFactoryRegister(azule::Entity);
	ObjectFactoryRegister(azule::TransformComponent);
	ObjectFactoryRegister(azule::AnimationComponent);
	ObjectFactoryRegister(azule::SelectionComponent);
	ObjectFactoryRegister(azule::DatabaseTexture);
	ObjectFactoryRegister(azule::BoxSelectionComponent);
	...
	ObjectFactoryRegister(azule::Window);
